    ...
    <div className="min-h-screen">
      ...
      <div className="mx-auto max-w-7xl px-6 py-12">
        <div className="mb-8 flex flex-col sm:flex-row sm:items-end justify-between gap-4">
          <div>
            <h1 className="font-serif text-[36px] leading-[44px] font-semibold text-foreground">Directory</h1>
            <p className="mt-2 text-lg text-muted max-w-xl">
              {isApproved
                ? 'Showing full details available to approved members.'
                : 'Public view — contact details are hidden for privacy.'}
            </p>
          </div>
          {isApproved && (
            <Link href="/submit/new-household">
              <Button variant="secondary" className="text-sm py-2 px-6 border border-border/50 bg-surface hover:bg-surface-hover shadow-sm">
